export default function AnimatedLayout() {
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden bg-gradient-to-br transition-colors duration-300
        ${isDark ? "dark:from-blue-950 dark:via-slate-900 dark:to-blue-950 text-gray-100" : "from-blue-50 via-blue-100 to-blue-200 text-gray-900"}`}>

      {/* Rotating Logo and blobs stay static */}
      <motion.img
        src="/fav-2.png"
        alt="Logo"
      ...
      <AnimatePresence mode="wait" initial={false}>
        <motion.div
          key={location.pathname} // remove theme from key
          variants={variants}
          initial="initial"
          animate="animate"
          exit="exit"
