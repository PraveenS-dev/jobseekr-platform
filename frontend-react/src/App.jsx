      ...
      <AuthProvider>
        <Routes>
          ...
          <Route path="/bookmarks" element={
            <ProtectedRoute>
              <MainLayout><Bookmarks /></MainLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/jobs/store" element={
            <ProtectedRoute>
              <MainLayout><AddJobs /></MainLayout>
            </ProtectedRoute>
          } />
          <Route path="/view-job/:id" element={
            <ProtectedRoute>
              <MainLayout><ViewJobs /></MainLayout>
            </ProtectedRoute>
          } />
          <Route path="/view-job/approval/:id" element={
            <ProtectedRoute>
              <MainLayout><ViewJobs approvalMode={true} /></MainLayout>
            </ProtectedRoute>
          } />
          <Route path="/apply-job/:id" element={
            <ProtectedRoute>
              <MainLayout><JobApply /></MainLayout>
            </ProtectedRoute>
          } />
          <Route path="/application/list" element={
            <ProtectedRoute>
              <MainLayout><ApplicationList /></MainLayout>
            </ProtectedRoute>
          } />
          <Route path="/application/view/:id" element={
            <ProtectedRoute>
              <MainLayout><ApplicationView /></MainLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/admin/job-approval" element={
            <ProtectedRoute>
              <MainLayout><JobApproval /></MainLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/users/editProfile/:id" element={
            <ProtectedRoute>
              <MainLayout><UpdateProfile /></MainLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/notifications" element={
            <ProtectedRoute>
              <MainLayout><AllNotifications /></MainLayout>
            </ProtectedRoute>
          } />
